  ...
  return (
    ...
    >
      <LiquidMetal
         ...
         * 33% 余量，漂移全程不触边。
         * offsetX/offsetY 默认 0 是视口正中央——那正好压在 Hero 标题和副标题
         * 上（用户多次报告文字被球挡住，要求「字后面不要有任何遮挡」）。
         * 这里把液滴群缩小并下移：scale 0.5→0.38 让直径从短边的 67% 降到约
         * 50%，offsetY 0.3 把整体推到文字下方，于是 badge/标题/副标题/按钮
         * 这一带背后是干净的，液滴在页面下半部活动。
         */
        scale={0.38}
        offsetY={0.3}
        softness={0.45}

    ...
    skills: {
      ...
      projects: {
        ...
        items: [
          ...
          {
            name: "图生 3D 高斯泼溅",
            desc: "浏览器里把一张图片或一段视频变成可旋转的 3D 高斯泼溅点云：Depth Anything V2 在本地估出逐像素深度，生成数十万枚带原图颜色的高斯圆盘，three.js 实时渲染，可导出 .ply / .splat 给 Blender、SuperSplat 使用。模型自托管，WebGPU fp16 优先、自动回退 int8 + WASM，文件不出浏览器。",
            tags: ["JavaScript", "ONNX Runtime", "WebGPU", "three.js"],
            repo: "https://github.com/ForJiang/image-to-splat",
            demo: "https://forjiang.github.io/image-to-splat/",
          },
          {
            name: "函数图像生成器",
  ...
  en: {
    ...
    skills: {
      ...
      projects: {
        ...
        subtitle: "Five fully static, offline-capable web tools",
        demoCta: "Live demo",
        ...
        items: [
          ...
          {
            name: "Image to 3D Splat",
            desc: "Turns a photo or a video into a rotatable 3D Gaussian-splat point cloud in the browser: Depth Anything V2 estimates per-pixel depth locally, spawning hundreds of thousands of Gaussian discs in the original colors, rendered live with three.js and exportable as .ply / .splat for Blender or SuperSplat. Self-hosted models, WebGPU fp16 with int8 + WASM fallback — files never leave the device.",
            tags: ["JavaScript", "ONNX Runtime", "WebGPU", "three.js"],
            repo: "https://github.com/ForJiang/image-to-splat",
            demo: "https://forjiang.github.io/image-to-splat/",
          },
